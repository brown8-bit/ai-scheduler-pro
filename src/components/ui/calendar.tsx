  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        day: cn(buttonVariants({ variant: "ghost" }), "h-10 w-10 sm:h-9 sm:w-9 p-0 font-normal aria-selected:opacity-100 touch-manipulation active:scale-95 transition-transform"),
